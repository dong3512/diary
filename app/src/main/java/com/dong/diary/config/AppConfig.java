...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    // 
    sqlSessionFactoryBean.setTypeAliasesPackage("com.dong.diary.domain");
    sqlSessionFactoryBean.setMapperLocations(
        appCtx.getResources("classpath:com/dong/diary/mapper/*Mapper.xml"));
